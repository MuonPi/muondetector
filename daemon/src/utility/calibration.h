...
static const std::vector<std::tuple<std::string, std::string, std::string>> CALIBITEMS = {
    std::make_tuple("VERSION", "UINT8", "3"),      std::make_tuple("FEATURE_FLAGS", "UINT8", "0"),
    std::make_tuple("CALIB_FLAGS", "UINT8", "0"),  std::make_tuple("DATE", "UINT32", "0"),
    std::make_tuple("RSENSE", "UINT16", "100"),    std::make_tuple("VDIV", "UINT16", "1100"),
    std::make_tuple("COEFF0", "FLOAT", "0.0"),     std::make_tuple("COEFF1", "FLOAT", "1.0"),
    std::make_tuple("COEFF2", "FLOAT", "0.0"),     std::make_tuple("COEFF3", "FLOAT", "1.0"),
