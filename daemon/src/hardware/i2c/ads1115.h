...
class ADS1115 : public i2cDevice,
                ...
                public static_device_base<ADS1115> {
  public:
  ...
  protected:
    ...
    bool fAGC[4]{false, false, false, false}; ///< software agc which switches over to a better pga
    ...
    enum REG : uint8_t { CONVERSION = 0x00, CONFIG = 0x01, LO_THRESH = 0x02, HI_THRESH = 0x03 };
    ...
    static constexpr auto lsb_voltage(const CFG_PGA pga_setting) -> float {
