...
ADS1115Driver::ADS1115Driver(ComponentId id, DeviceRegistry &registry, EventBus &bus, boost::asio::io_context &io)
...
void ADS1115Driver::update()
{
    ...
    for (std::size_t channel = 0; channel < 4; ++channel)
    {
        ...
        bus_.publish(Ads1115Event{adc.getAddress(), static_cast<std::uint8_t>(channel),
