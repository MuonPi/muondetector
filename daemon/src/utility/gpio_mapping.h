...
// Mapping between signals of the MuonPi hardware interface and the actual GPIO pins of the
// RaspberryPi ATTENTION: All pins are numbered according to the BCM designation
