...
if(APPLE)
  ...
  set(myApp_ICON ${CMAKE_CURRENT_SOURCE_DIR}/gui/res/muon.icns)
  ...
  set_target_properties(muondetector-gui PROPERTIES MACOSX_BUNDLE_INFO_PLIST ${CMAKE_SOURCE_DIR}/gui/res/Info.plist.in)
