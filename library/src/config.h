...
[[maybe_unused]] static const Version software{CMake::Version::major, CMake::Version::minor,
                                               CMake::Version::patch, CMake::Version::additional,
                                               CMake::Version::hash};
} // namespace MuonPi::Version
...
constexpr std::uint8_t bias1{
    2}; //!< channel of the adc where the divided bias voltage before the current shunt is sampled
constexpr std::uint8_t bias2{
    3}; //!< channel of the adc where the divided bias voltage after the current shunt is sampled
} // namespace Channel
