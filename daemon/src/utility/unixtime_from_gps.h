...
static inline timespec unixtime_from_gps(int week_nr, std::int64_t s_of_week, std::int64_t ns) {
    std::int64_t secs = GPS_UNIX_EPOCH_OFFSET +
                        static_cast<std::int64_t>(week_nr) * 7LL * 24LL * 3600LL + s_of_week;
