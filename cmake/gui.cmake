...
set(MUONDETECTOR_QWT_PRIVATE_LIBRARY_DIRS)
set(MUONDETECTOR_INSTALL_PRIVATE_QWT OFF)

if(QWT_LIBRARY)
    get_filename_component(MUONDETECTOR_QWT_LIBRARY_DIR "${QWT_LIBRARY}" DIRECTORY)
    list(APPEND MUONDETECTOR_QWT_PRIVATE_LIBRARY_DIRS "${MUONDETECTOR_QWT_LIBRARY_DIR}")

    if(CMAKE_CROSSCOMPILING AND CMAKE_SYSROOT
        AND MUONDETECTOR_QWT_LIBRARY_DIR MATCHES "^${CMAKE_SYSROOT}/home/"
    )
        set(MUONDETECTOR_INSTALL_PRIVATE_QWT ON)
    endif()
endif()

if(BUILDING_BUNDLED_QWT)
    set(MUONDETECTOR_QWT_LIBRARY_DIR "${CMAKE_BINARY_DIR}/_deps/qwt-build/lib")
    list(APPEND MUONDETECTOR_QWT_PRIVATE_LIBRARY_DIRS "${MUONDETECTOR_QWT_LIBRARY_DIR}")
    set(MUONDETECTOR_INSTALL_PRIVATE_QWT ON)
endif()

if(MUONDETECTOR_QWT_PRIVATE_LIBRARY_DIRS)
    list(REMOVE_DUPLICATES MUONDETECTOR_QWT_PRIVATE_LIBRARY_DIRS)
    list(APPEND CPACK_DEBIAN_PACKAGE_SHLIBDEPS_PRIVATE_DIRS
        ${MUONDETECTOR_QWT_PRIVATE_LIBRARY_DIRS}
    )
