...
class PlotCustom : public QwtPlot {
  public:
    ...
    PlotCustom(const QwtText& title_l, QWidget* parent = 0) : QwtPlot(title_l, parent) {
        initialize();
    }

    // for other plots: subclass "PlotCustom" and put all specific functions (like below) to the new
    // class
